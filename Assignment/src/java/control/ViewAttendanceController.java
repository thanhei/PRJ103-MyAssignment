...
public class ViewAttendanceController extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        ArrayList<Student> slist=sdb.getStudentbySidAndGid(seid);
        ArrayList<Attendance> alist=adb.listbyGid(gid);
        request.setAttribute("slist", slist);
        request.setAttribute("alist", alist);
        request.setAttribute("gcode", gcode);
        request.getRequestDispatcher("../view/lecture/viewattendance.jsp").forward(request, response);
